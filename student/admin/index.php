...
<html lang="<?php echo $lang; ?>">
    <head>
        <title><?php echo $translations["welcome"]; ?>student registration</title>
...
/*---------------------footer-------------------------------*/
    ...
    <div class="search-bar1">
                <h1 style="color:white"><?php echo $translations["welcome"]; ?></h1>
                </div>
    ...
    <div class="books-grid"> 
        ...
        if (mysqli_num_rows($result) > 0) {  
            while ($row = mysqli_fetch_assoc($result)) {  
                ...
                echo '<a href="see_detail.php?bid='.$row['bid'].'"><button class="borrow-btn">See Details</button></a>'; 
    ...
    <div class="view-all-container">
        <a href="view_all_book.php" class="view-all-link">View All Books &gt;</a>
    </div>
</div>
<script>
