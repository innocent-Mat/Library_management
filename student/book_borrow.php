...
if (isset($_POST['format']) && isset($_SESSION['login_user'])) {  
    ...
    // Update the books table to increment reads or downloads
    if ($format === "Hardcover") {
...
/*---------------------footer-------------------------------*/
    footer {  
        background-color:beige; /* Change to desired color */  
        padding: 20px;  
        text-align: left;  
    }  
...
<section class="wrapper">
    ...
    <div class="footer-subscribe">
        ...
        <p>Stay updated with the latest books and offers!</p>
...
function validateEmail(email) {
    ...
    <div class="footer-bottom">  
        <p>&copy; <?php echo date("Y"); ?> BetterWorldBooks</p>  
